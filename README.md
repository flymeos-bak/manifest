...
通过repo sync命令同步远程代码: 
    ...
    $ repo init -u https://github.com/FlymeOS-bak/manifest.git -b marshmallow-6.0
    $ repo sync -c -j4

如果连接一直失败或下载代码过慢，则使用以下命令:

    $ repo init --repo-url git://github.com/FlymeOS-bak/repo.git \
                -u https://github.com/FlymeOS-bak/manifest.git \
